...
public class Crawler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (queue.getWaitThreads() != threads) {
            if (Thread.activeCount() - initialActive < threads) {
                CrawlerTask crawler = new CrawlerTask(queue);
    ...
    public static LinkedList<URLDepthPair> FindLinks(int depth) throws IOException {
        while(!queue.IsEmpty()) {
